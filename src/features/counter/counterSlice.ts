...
export const autoIncrement = (amount: number, numTimes: number): AppThunk =>
    (dispatch/*, getState*/) => {
      ...
      dispatch(targetVisibilityWasToggled());
      if(numTimes >= 2) {
        setTimeout(() => {
...
export const counterSlice = createSlice({
  ...
  reducers: {
    ...
    targetVisibilityWasToggled: (state) => {
...
export const { increment, decrement, incrementByAmount, targetVisibilityWasToggled } = counterSlice.actions;
